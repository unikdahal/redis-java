...
import com.redis.commands.generic.DelCommand;
...
/**
 * Unit tests for GET and DEL commands
 */
@DisplayName("GET Command Unit Tests (Combined)")
class GetCommandCombinedTest {
    ...
    void testGetTooManyArgs() {
        List<String> args = Arrays.asList("key", "extra_arg");
        String result = command.execute(args, mockCtx);
        assertTrue(result.contains("ERR"));
    }
...
@DisplayName("DEL Command Unit Tests (Combined)")
class DelCommandCombinedTest {
